                                ...
                                @forelse($events as $event)
                                    <tr>
                                        ...
                                        <td class="text-end px-4">
                                            <a href="{{ route('events.show', $event->id) }}" class="btn btn-sm btn-info me-2">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center py-4">
                                            <div class="d-flex flex-column align-items-center">
                                                ...
                                                <p class="mb-0 mt-2">No hay eventos registrados</p>
                                                <a href="{{ route('events.create') }}" class="btn btn-sm btn-primary mt-3">
                                                    <i class="bi bi-plus-circle me-1"></i>
                                                    Crear Nuevo Evento
                                                </a>
                                            </div>
